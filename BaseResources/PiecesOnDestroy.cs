...
[GlobalClass, Tool]
public partial class PiecesOnDestroy : BreakableOnDestroyStrategy
{
    [Export]
    ...
    public void PiecesFlyOut(List<RigidBody3D> pieces, float force = 0f, Vector3? hitDirection = null)
    {
